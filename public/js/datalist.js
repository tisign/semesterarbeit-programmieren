//Black magic for styling datalist - Stackoverflow to the rescue
export function datalist() {
  ...
  function n(t) {
    ...
    Array.from(e.datalist.getElementsByTagName("option")).forEach((t) => {
      t.setAttribute("tabindex", 0),
        (t.style.display =
          !n || t.value.toLowerCase().includes(n) ? "block" : "none");
    });
  }
  function i(t) {
    const n = c(t);
  ...
  document.body.addEventListener("focusin", function (s) {
    ...
    r &&
      ...
      (r.shown = !0),
      n(s),
      (r.style.width = a.offsetWidth + "px"),
      (r.style.left = a.offsetLeft + "px"),
  ...
  function a(t, e) {
    ...
    do {
      e < 0
        ...
        : e > 0 && (n = n.nextElementSibling),
        n && n.offsetHeight && ((t = n), (e -= Math.sign(e)));
    } while (n && e);
    return t;
  }
  function l(t) {
